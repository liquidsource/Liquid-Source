...
<header><h3 class="tabs_involved">Post Categories</h3></header>
...
<form method="post" action="scripts/action.php?action=newcategory&to=postcategories&c_type=post&cid=<?php echo $cid; ?>">
<article class="module width_full">
